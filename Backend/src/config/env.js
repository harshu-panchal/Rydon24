...
const resolvedJwtExpiresIn =
  process.env.JWT_EXPIRES_IN || process.env.JWT_ACCESS_EXPIRES || "7d";
...
if (!resolvedJwtSecret) {
  throw new Error(
    "Missing required environment variable: JWT_SECRET or JWT_ACCESS_SECRET",
  );
}
...
export const env = {
  ...
  // Example:
  // CORS_ORIGIN=https://admin.rydon24.com,https://rydon24.com,http://localhost:5173
  ...
  driverWallet: {
    defaultCashLimit: Number.isFinite(
